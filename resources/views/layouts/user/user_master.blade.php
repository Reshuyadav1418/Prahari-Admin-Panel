...
<head>
    ...
    <title> Meno - Bootstrap 5 Premium User & Dashboard Template </title>
    <meta name="Description" content="Bootstrap Responsive User Web Dashboard HTML5 Template">
    <meta name="Author" content="Spruko Technologies Private Limited">
    <meta name="keywords"
        content="bootstrap template, dashboard, bootstrap user dashboard, user template, bootstrap 5 templates, user, user dashboard template, bootstrap dashboard, bootstrap user template, template bootstrap 5, dashboard template bootstrap, user dashboard ui, template user, dashboard user, dashboard template, bootstrap user panel">
